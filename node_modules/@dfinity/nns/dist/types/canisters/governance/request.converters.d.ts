...
import type { Command as RawCommand, ListNeurons as RawListNeurons, ListProposalInfo, ManageNeuron as RawManageNeuron, Operation as RawOperation } from "../../../candid/governance";
...
export declare const toDisburseNeuronRequest: ({ neuronId, toAccountIdentifier, amount, }: {
    neuronId: NeuronId;
    toAccountIdentifier?: AccountIdentifierClass | undefined;
